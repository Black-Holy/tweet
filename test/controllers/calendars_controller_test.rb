...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post calendars_url, params: { calendar: { description: @calendar.description, end_date: @calendar.end_date, start_date: @calendar.start_date, title: @calendar.title } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { description: @calendar.description, end_date: @calendar.end_date, start_date: @calendar.start_date, title: @calendar.title } }
